...
public partial class Menubar : MenuBar
{
    ...
    public override void _Ready()
    {
        ...
        load_confirmation.OkButtonText = "Save";
        load_confirmation.CancelButtonText = "Give up";
        load_confirmation.Title = "Load Chart From File";
        load_confirmation.DialogText = "Current chart is unsaved.Would you like to save it before loading?";
    ...
    async void on_load_confirmation_confirmed()
    {
        ...
        else
        {
            ...
            Editor.Instance.TipManager.AddTip($"Saved at {Editor.SavePath}!", 1.5f, TipManager.TipIcon.Information, TipManager.TipColor.Green);
        }
        Editor.Instance.LoadDialog.PopupCentered();
    }
    ...
    void chart_info_dialog_confirmed()
    {
        ...
        if (int.TryParse(level, out int level_r))
        {
            Editor.Level = level_r;
        }
        else
        {
            Editor.Instance.TipManager.AddTip("Level not modified.Please input a valid integer value.", 3.0f,
        ...
        {
            Editor.Instance.TipManager.AddTip("BPM not modified.Please input a valid float value.", 3.0f,
                TipManager.TipIcon.Information, TipManager.TipColor.Yellow);
        }
        ...
        {
            Editor.Instance.TipManager.AddTip("Chart Offset not modified.Please input a valid float value.", 3.0f,
                TipManager.TipIcon.Information, TipManager.TipColor.Yellow);
        }
        ...
        {
            Editor.Instance.TipManager.AddTip("BackGround Offset not modified.Please input a valid float value.", 3.0f,
                TipManager.TipIcon.Information, TipManager.TipColor.Yellow);
        }

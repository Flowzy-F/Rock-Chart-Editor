...
public partial class Editor : Node
{
    ...
    #region Menubar Dialogs
    public static ConfirmationDialog load_confirmation;
    public static ChartInfoDialog chart_info_dialog;
    public static SettingsDialog settings_dialog;
    public static AcceptDialog about_dialog;
    #endregion
